...
col1.write("""
    <div style="text-align: left; font-family: 'Arial', sans-serif; font-size: 23px;">
        ...
        our advanced technology aims to make screening more accessible, prioritizing the safety and affordability of digital X-Rays.<br>
           <br>
        <b>Proactive Healthcare is here at St. Matthew Hospital!</b>
    </div>
""", unsafe_allow_html=True)
...
col4.write("""
    <div style="text-align: left; font-family: 'Arial', sans-serif; font-size: 24px;">
        We were honored with an award for a new
